  ...
  return (
    <main>
      ...
      <section style={{ padding: '4rem 0', backgroundColor: '#fff' }}>
        <div className="container">
          <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
            <h2 style={{ fontSize: '2.5rem', marginBottom: '1.5rem', color: 'var(--primary-color)' }}>About Magazine Kids</h2>
            <p style={{ fontSize: '1.2rem', lineHeight: '1.8', color: '#555' }}>
              ...
              We provide age-appropriate content that is both educational and entertaining.
              With a focus on science, history, nature, and current events, Magazine Kids helps children
      ...
      <section style={{ padding: '4rem 0', backgroundColor: '#f9f9f9' }}>
        <div className="container">
          <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem', textAlign: 'center' }}>Recent Magazines</h2>
          {loading ? (
      ...
      <section style={{ padding: '4rem 0', backgroundColor: '#fff' }}>
        <div className="container">
          <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem', textAlign: 'center' }}>More Magazines</h2>
          {loading ? (
            <div style={{ textAlign: 'center', padding: '2rem' }}>Loading...</div>
          ) : (
            <div style={{
