    ...
    const magazines = await Promise.all([
        prisma.magazine.create({
            data: {
                ...
                description: 'Journey to the stars and discover the wonders of space, planets, and galaxies.',
                category: '8-11',
                active: true,
            },
        }),
        prisma.magazine.create({
            data: {
                ...
                publisher: 'Magazine Kids Publishing',
                description: 'Dive deep into the ocean and explore amazing sea creatures and underwater worlds.',
                category: '8-11',
                active: true,
            },
        }),
        ...
        prisma.magazine.create({
            data: {
                ...
                publisher: 'Magazine Kids Publishing',
                description: 'Explore cutting-edge technology, coding, robotics, and the future of innovation.',
                category: '15-16',
                active: true,
            },
        }),
        ...
        prisma.magazine.create({
            data: {
                ...
                slug: 'wild-safari',
                publisher: 'Magazine Kids Publishing',
                description: 'Meet the kings of the jungle and discover amazing wildlife from around the world.',
                category: '8-11',
                active: true,
            },
        }),
        prisma.magazine.create({
            data: {
                ...
                slug: 'science-lab',
                publisher: 'Magazine Kids Publishing',
                description: 'Conduct experiments, learn about chemistry, physics, and the scientific method.',
                category: '12-14',
                active: true,
            },
        }),
